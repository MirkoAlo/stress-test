...
const $$Home = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Home;
  return renderTemplate`${renderComponent($$result, "Base", $$Base, { "title": "Homepage" }, { "default": ($$result2) => renderTemplate`
  ${renderComponent($$result2, "Button", $$Button, { "className": "secondary", "label": "test" })}
` })}`;
}, "C:/Users/Liqueedo/Documents/Develop/stress-test/src/pages/view/home.astro", void 0);

const $$file = "C:/Users/Liqueedo/Documents/Develop/stress-test/src/pages/view/home.astro";
const $$url = "/view/home.html";
